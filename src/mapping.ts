...
export function handleAddressUpdated(event: AddressUpdated): void {
  ...
  // - contract.L1_ADMIN_ROLE(...)
  // - contract.L2_ADMIN_ROLE(...)
  // - contract.VAULT(...)
  // - contract.getAddress(...)
  // - contract.getRewardsAccrued(...)
  ...
  // - contract.rewardAccrued(...)
  // - contract.rewardIndex(...)
  // - contract.rewardInitialIndex(...)
  // - contract.rewardSpeeds(...)
  // - contract.rewardState(...)
